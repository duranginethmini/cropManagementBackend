...
//            Optional<FieldEntity> field = fieldDAO.findById(staffDTO.getFieldCode());
//            if (!field.isPresent()) {
//                throw new FieldNotFoundException("Field not found for fieldCode: " + staffDTO.getFieldCode());
//            }
//
//           // Wrap the single FieldEntity in a list
//            List<FieldEntity> fieldEntities = List.of(field.get());
//
//          // Set the fieldEntities list to the staffEntity
//            staffEntity.setFieldEntities(fieldEntities);
//
//
//            // Save the updated staffEntity back to the database
//
...
//
//        // Update fields
//        if (staffDTO.getFieldCode() != null) {
//            FieldEntity fieldEntity = fieldDAO.findById(staffDTO.getFieldCode())
//                    .orElseThrow(() -> new FieldNotFoundException("Field not found for fieldCode: " + staffDTO.getFieldCode()));
//
